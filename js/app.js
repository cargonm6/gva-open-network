...
function loadIconSet(setName) {
  ...
  icons = {
    ...
    smartphone: loadIcon(`img/devices/${setName}/smartphone.svg`),
    repeater: loadIcon(`img/devices/${setName}/repeater.svg`),
    mau: loadIcon(`img/devices/${setName}/mau.svg`),
    firewall: loadIcon(`img/devices/${setName}/firewall.svg`),
    ups: loadIcon(`img/devices/${setName}/ups.svg`),
